...
<div class=" register">
                <div class="row">
                    <div class="col-md-3 register-left">
                        ...
                        <h3>Variant Lookup</h3>
                        <p>Are you ready for a tap to full variant analysis?!</p>
                        <input type="submit" name="" value="Login"/><br/>
                    </div>
                    <div class="col-md-9 register-right">
                        
                        <div class="">
                            <h3 class="register-heading text-muted fw-light">Variant Details</h3>
                                <div class="row register-form">
                                    <div class="col-md">
                                        ...
                                        <form action="#" method="post" id="form">
                                            ...
                                            <input type="submit" value="locate" data-mdb-toggle="popover" class="btn btn-primary btn-rounded ripple-surface">
